...
public class Navigation {
    ...
    public static String SPRING_APPLICATION_FILE = "caillou/company/clonemanager/gui/spring/ApplicationContext.xml";
    
    public static String SEARCH_VIEW = "/caillou/company/clonemanager/gui/customComponent/search/SearchView.fxml";
    public static String TASK_CHOICE_VIEW = "/caillou/company/clonemanager/gui/customComponent/taskchoice/TaskChoiceView.fxml";
    ...
    public static String SUPPRESSION_ALL_DOUBLONS_POPUP = "/caillou/company/clonemanager/gui/customComponent/ConfirmSuppressionAllDoublons.fxml";
